...
export default function AsianRecipes() {
    ...
    const CategoryId = getIdByRouteName('asianrecipes');
    ...
    return (
        <div>
            ...
            <div className="flex flex-col items-center mt-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 pl-10 pr-10">
